...
local function AutoPickup()
    ...
    for Index, Value in next, workspace.placeFolders.items:GetChildren() do 
        ...
        if itemName == "coin piece" or itemName == "crystal beetle" or itemName == "megaphone" or itemName == "dustworm longbow" or itemName == "sand ravaged bow" or itemName == "dustworm cudgel" or itemName == "sand ravaged scimitar" or itemName == "chitin scythe" or itemName == "stingtail staff" or itemName == "azariah edge" or itemName == "scarab tongue boots" or itemName == "auktufiti ballista" then
